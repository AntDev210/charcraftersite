const article_CharCrafter = {
    ...
    content: `
        ...
        <ul class="wiki-list">
            <li><span class="key">W,A,S,D</span> : Move on the map, minimap, micromap and cavemap.</li>
            ...
            <li><span class="key">"Q (number)"</span> : Dropping a number of items.</li>
            ...
            <li><span class="key">(inventory item)</span> : for selecting an item in the inventory menu.</li>
            <li><span class="key">(crafting item), "(crafting item) (number)"</span> : for selecting an item in the crafting menu.</li>
        </ul>
        ...
        <p>Multiplayer mode will allow a user to invite a friend into their world. There will also be a section for exchanging messages between users.</p>
        <p>Multiplayer game time will follow real-world time, with a temporary pause for players performing time-consuming actions, resuming only after all players have started doing something time-consuming or until the timer runs out.</p>
    `,
    infobox: {
        "Name": "CharCrafter",
