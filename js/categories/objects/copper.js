const article_Copper = {
    ...
    content: `
        ...
        <h3 class="pixel-text" style="color: #FF6600; margin-top: 20px;">LOCATION AND IDENTIFICATION</h3>
        ...
        <h3 class="pixel-text" style="color: #FF6600; margin-top: 20px;">EXTRACTION AND ENERGY COSTS</h3>
        ...
        <h3 class="pixel-text" style="color: #FF6600; margin-top: 20px;">METALWORKER CRAFTING AND USAGE</h3>
        ...
        <h5 class="pixel-text" style="color: #FF6600; margin-top: 20px;">COMPONENTS AND TOOLS</h5>
        <ul class="wiki-list">
        ...
        <h5 class="pixel-text" style="color: #FF6600; margin-top: 20px;">COPPER ARMOR (UNIT COSTS)</h5>
        <ul class="wiki-list">
        ...
        <h5 class="pixel-text" style="color: #FF6600; margin-top: 20px;">FOOD PROCESSING</h5>
        ...
        <h3 class="pixel-text" style="color: #FF6600; margin-top: 20px;">ECONOMIC VALUE AND LOGISTICS</h3>
