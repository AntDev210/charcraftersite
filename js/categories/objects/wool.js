const article_Wool = {
    ...
    content: `
        ...
        <p>Four units of Wool (wool: 4) are required to produce a single Ball of Wool (ball of wool: 1). The process demands between 30000 and 40000 seconds of work.</p>
        
        <h3 class="pixel-text" style="color: #00ff00; margin-top: 20px;">RELATED ITEMS</h3>
        <p>Below, you can find all the items related to wool:</p>
        <ul class="wiki-list">
            <li>Wool</li>
			<li>Ball Of Wool</li>
			<li>Water Filter</li>
    ...
    infobox: {
        ...
        "Base Conversion": "Ball of Wool (requires 4x raw Wool)",
